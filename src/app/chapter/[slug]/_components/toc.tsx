        ...
        <SelectGroup>
          ...
          <div className="py-2">
            {details.story.chapters.map((chapter) => (
              ...
              >
                <p className="focus:text-text-light focus:bg-accent relative flex w-full cursor-pointer select-none items-center rounded-sm py-1.5 pl-4 pr-2 text-sm outline-none hover:bg-slate-200 data-[disabled]:pointer-events-none data-[disabled]:opacity-50">
                  {chapter.title}
                </p>
                {chapter.isPremium && (
                  <span>
