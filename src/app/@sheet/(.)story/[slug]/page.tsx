...
import { BookOpen, Eye, LayoutList, PlusSquare, Star } from "lucide-react";
    ...
    >
      <SheetContent>
        ...
        >
          <ScrollArea type="always" className="h-full pr-3">
            <div className="pr-4">
              <div className="mb-8">
                ...
                <SheetDescription>{activeBook?.description}</SheetDescription>
              </div>
              <div className="mb-8">
              ...
              <div>
                ...
                {(activeBook?.chapter ?? []).length > 0 ? (
                  activeBook?.chapter.map((chapter) => (
                    <div
                      key={chapter.id}
                      className="mb-4 flex cursor-pointer items-center justify-between border-b border-border py-2 last:border-0"
                    >
          ...
          <div className="absolute bottom-0 left-0 flex w-full items-center gap-2 bg-background pt-4">
